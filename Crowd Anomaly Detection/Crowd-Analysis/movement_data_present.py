...
tracks = []
with open('C:/Users/kanis/OneDrive/Desktop/crowd 4/processed_data/movement_data.csv', 'r') as file:
...
with open('C:/Users/kanis/OneDrive/Desktop/crowd 4/processed_data/video_data.json', 'r') as file:
	data = json.load(file)
