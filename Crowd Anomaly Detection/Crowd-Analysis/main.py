...
if IS_CAM: 
	...
	if max_age > 30:
		max_age = 30
model_filename = 'C:/Users/kanis/OneDrive/Desktop/crowd 4/Crowd-Analysis/model_data/mars-small128.pb'
...
movement_data_file = open('C:/Users/kanis/OneDrive/Desktop/crowd 4/processed_data/movement_data.csv', 'w') 
crowd_data_file = open('C:/Users/kanis/OneDrive/Desktop/crowd 4/processed_data/crowd_data.csv', 'w')
...
if os.path.getsize('C:/Users/kanis/OneDrive/Desktop/crowd 4/processed_data/movement_data.csv') == 0:
	movement_data_writer.writerow(['Track ID', 'Entry time', 'Exit Time', 'Movement Tracks'])
if os.path.getsize('C:/Users/kanis/OneDrive/Desktop/crowd 4/processed_data/crowd_data.csv') == 0:
...
with open('C:/Users/kanis/OneDrive/Desktop/crowd 4/processed_data/video_data.json', 'w') as video_data_file:
